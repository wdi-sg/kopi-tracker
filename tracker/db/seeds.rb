...
# Kopi.create(name: 'Arabica', roast_id: 'Cinnamon', origin_id: 1)
# Kopi.create(name: 'Robusta', roast: 'Light', origin_id: 2)
# Kopi.create(name: 'Liberian', roast: 'Full City', origin_id: 3)
