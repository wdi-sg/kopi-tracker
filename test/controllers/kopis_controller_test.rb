...
class KopisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kopi" do
    assert_difference('Kopi.count') do
      post kopis_url, params: { kopi: { name: @kopi.name, origin_id: @kopi.origin_id, roast: @kopi.roast } }
    end
  ...
  test "should update kopi" do
    patch kopi_url(@kopi), params: { kopi: { name: @kopi.name, origin_id: @kopi.origin_id, roast: @kopi.roast } }
