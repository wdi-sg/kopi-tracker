...
k1 = Kopi.create(name: 'black', roast: 'italian', origin_id: 1)
k2 = Kopi.create(name: 'gray', roast: 'full city', origin_id: 1)
k3 = Kopi.create(name: 'blue', roast: 'dark', origin_id: 1)

k4 = Kopi.create(name: 'mountain', roast: 'light', origin_id: 2)
k5 = Kopi.create(name: 'river', roast: 'city', origin_id: 2)
k6 = Kopi.create(name: 'sea', roast: 'french', origin_id: 2)

k7 = Kopi.create(name: 'town', roast: 'medium', origin_id: 3)
k8 = Kopi.create(name: 'sub', roast: 'cinnamon', origin_id: 3)
k9 = Kopi.create(name: 'dinky', roast: 'light', origin_id: 3)

c1 = Customer.create(name: "teo")
c2 = Customer.create(name: "chang")
c3 = Customer.create(name: "hao")
c4 = Customer.create(name: "claudia")
c5 = Customer.create(name: "rachel")
c6 = Customer.create(name: "sweechin")
c7 = Customer.create(name: "sean")
c8 = Customer.create(name: "andy")
c9 = Customer.create(name: "jordan")
c10 = Customer.create(name: "ccb")

k1.customer << [c1, c4, c7]
k2.customer << [c2, c8, c9]
k3.customer << [c5, c6, c10]
k4.customer << [c2, c1, c8]
k5.customer << [c3, c7, c10]
k6.customer << [c1, c2, c3]
k7.customer << [c4, c5, c6]
k8.customer << [c7, c8, c9]
k9.customer << [c2, c4, c6]
