...
# Origin.create(location: 'Colombia', phone: '2759908172', kopi: 1)
# Origin.create(location: 'Colombia', phone: '2759908172', kopi: 2)
# Origin.create(location: 'Brazil', phone: '6750008172', kopi: 3)
# Origin.create(location: 'Brazil', phone: '6750008172', kopi: 4)
# Origin.create(location: 'Colombia', phone: '2759908172', kopi: 5)
# Origin.create(location: 'Costa Rica', phone: '5759908172', kopi: 6)
# Origin.create(location: 'Guatemala', phone: '9759908172', kopi: 7)
# Origin.create(location: 'Colombia', phone: '2759908172', kopi: 8)
# Origin.create(location: 'Guatemala', phone: '9759908172', kopi: 9)
# Origin.create(location: 'Italy', phone: '9759908172', kopi: 10)
# Origin.create(location: 'Guatemala', phone: '9759908172', kopi: 11)
# Origin.create(location: 'Costa Rica', phone: '5759908172', kopi: 12)