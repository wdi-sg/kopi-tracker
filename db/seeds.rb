...
Kopi.create(name: "Liberica", roast_id: 1, origin_id: 1)
Kopi.create(name: "Robusta", roast_id: 2, origin_id: 2)
Kopi.create(name: "Arabica", roast_id: 3, origin_id: 3)
Kopi.create(name: "Robusta", roast_id: 4, origin_id: 2)
Kopi.create(name: "Arabica", roast_id: 5, origin_id: 4)
Kopi.create(name: "Arabica", roast_id: 6, origin_id: 1)
Kopi.create(name: "Excelsa", roast_id: 4, origin_id: 4)