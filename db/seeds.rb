...
Customer.create(name: "Daniel")
Customer.create(name: "Deborah")
Customer.create(name: "Dominic")
Customer.create(name: "Nicholas")
Customer.create(name: "Jeremy")
Customer.create(name: "Lorenzo")
Customer.create(name: "Angelene")
