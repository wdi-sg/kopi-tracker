...
c2 = Customer.create(name: "teo")
c3 = Customer.create(name: "teo")
c4 = Customer.create(name: "teo")
c5 = Customer.create(name: "teo")
c6 = Customer.create(name: "teo")
c7 = Customer.create(name: "teo")
c8 = Customer.create(name: "teo")
c9 = Customer.create(name: "teo")
c10 = Customer.create(name: "teo")
