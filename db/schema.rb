...
ActiveRecord::Schema.define(version: 2020_05_13_162507) do
  ...
  create_table "kopis_customerss", force: :cascade do |t|
    t.bigint "kopi_id"
    t.bigint "customer_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["customer_id"], name: "index_kopis_customerss_on_customer_id"
    t.index ["kopi_id"], name: "index_kopis_customerss_on_kopi_id"
  end
