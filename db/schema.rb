...
ActiveRecord::Schema.define(version: 2019_05_01_135548) do
  ...
  create_table "customers", force: :cascade do |t|
    ...
    t.integer "kopi_count", default: 0
    t.bigint "user_id"
    t.index ["kopi_count"], name: "index_customers_on_kopi_count"
  ...
  add_foreign_key "customers_kopis", "customers"
  add_foreign_key "customers_kopis", "kopis"
