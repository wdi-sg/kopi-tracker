...
ActiveRecord::Schema.define(version: 2020_05_13_122308) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "customer_accs", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_customer_accs_on_email", unique: true
    t.index ["reset_password_token"], name: "index_customer_accs_on_reset_password_token", unique: true
  end
  ...
  create_table "customers", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "customer_acc_id", null: false
    t.index ["customer_acc_id"], name: "index_customers_on_customer_acc_id"
  end
  ...
  add_foreign_key "customers", "customer_accs"
