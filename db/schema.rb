...
ActiveRecord::Schema.define(version: 2019_05_01_175213) do
  ...
  create_table "kopis_users", force: :cascade do |t|
    t.bigint "kopi_id"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["kopi_id"], name: "index_kopis_users_on_kopi_id"
    t.index ["user_id"], name: "index_kopis_users_on_user_id"
  end
  ...
  create_table "roasts_users", force: :cascade do |t|
    t.bigint "roast_id"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["roast_id"], name: "index_roasts_users_on_roast_id"
    t.index ["user_id"], name: "index_roasts_users_on_user_id"
  end
